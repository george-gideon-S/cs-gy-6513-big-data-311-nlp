...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.85\linewidth]{figures/regressor_lift_by_category.pdf}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.85\linewidth]{figures/silhouette_w2v_vs_bert.pdf}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.85\linewidth]{figures/borough_volume.pdf}
